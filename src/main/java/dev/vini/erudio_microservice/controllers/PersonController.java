...
public class PersonController {
    ...
    @Operation(summary = "Adds a new person",
            description = "Adds a new person by passing in a JSON, XML e YML representation of the person.",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success",
                            responseCode = "200",
    ...
    @Operation(summary = "Updates a person's information",
            description = "Updates a person's information by passing in a JSON, XML e YML representation of the person.",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success",
                            responseCode = "200",
